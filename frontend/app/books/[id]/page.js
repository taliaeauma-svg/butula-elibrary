  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-3xl mx-auto px-6 py-14">
        ...
        {loading && (
          <div className="mt-8 text-gray-400 text-sm">Loading...</div>
        )}

        {!loading && notFound && (
          <div className="mt-8 bg-gray-50 border border-dashed border-gray-300 rounded-lg py-16 text-center text-gray-400">
            Resource not found.
          </div>
        )}
        ...
        {!loading && book && (
          <div className="mt-6 bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
            ...
            <p className="text-gray-500 mt-1">{book.author || "Unknown author"}</p>
            ...
            {book.file_url ? (
              ...
              <p className="mt-8 text-sm text-gray-400">No file attached to this resource.</p>
            )}
          </div>
        )}
      </section>
